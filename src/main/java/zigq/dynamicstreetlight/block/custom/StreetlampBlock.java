...
public class StreetlampBlock extends AbstractFlickeringBlock {
    public static final MapCodec<StreetlampBlock> CODEC = createCodec(settings -> new StreetlampBlock(settings, VoxelShapes.fullCube()));

    @Override
    public MapCodec<? extends StreetlampBlock> getCodec() {
        return CODEC;
    }
