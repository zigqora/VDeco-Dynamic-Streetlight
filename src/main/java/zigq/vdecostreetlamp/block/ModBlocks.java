...
public class ModBlocks {
    ...
    private static final FabricBlockSettings STREETLIGHT_SETTINGS = FabricBlockSettings.copyOf(Blocks.STONE).nonOpaque();

    private static VoxelShape makeStreetlightBottomShape() {
        return VoxelShapes.union(
                VoxelShapes.cuboid(0.3125, 0, 0.3125, 0.6875, 0.1875, 0.6875),
                VoxelShapes.cuboid(0.375, 0, 0.375, 0.625, 1, 0.625)
        ).simplify();
    }
